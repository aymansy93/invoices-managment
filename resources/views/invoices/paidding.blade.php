        ...
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto">الفواتير</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/
                    @php
                        if ($id == 1) {
                            echo 'الفواتير المدفوعة';
                        } elseif ($id == 2) {
                            echo 'الفواتير الغير مدفوعة';
                        } elseif ($id == 3) {
                            echo 'الفواتير المدفوعة جزئيا';
                        }
                    @endphp</span>
            </div>
        </div>
                            ...
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input class="form-control" name="invoice_name" id="invoice_name" type="text"
                                        readonly>
                                    <form action="{{ route('invoices.destroy', 'invoice') }}" id="id"
                                        method="post">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content modal-content-demo">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input class="form-control" name="invoice_name" id="invoice_name" type="text"
                                        readonly>
                                    <form action="{{ route('invoices.destroy', 'invoice') }}" id="id-archive"
                                        method="post">
                                        @method('DELETE')
                                        @csrf
                                        <input type="hidden" name="id" id="id" value="">
...
@section('js')
    ...
    <script>
        $('#modaldemo').on('show.bs.modal', function(event) {
            var button = $(event.relatedTarget)
            var id_archive = button.data('invoice_id')
            var invoice_name = button.data('invoice_name')
            var modal = $(this)
            modal.find('.modal-body #id').val(id_archive);
            modal.find('.modal-body #invoice_name').val(invoice_name);
        })
    </script>
@endsection
