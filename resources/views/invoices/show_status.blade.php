                    ...
                    <form action="{{ route('status_update', ['id' => $invoices->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="section" class="form-control" disabled readonly>
                                    <!--placeholder-->
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" class="form-control" disabled readonly>
                                    <option value="{{ $invoices->product }}">
                                        {{ $invoices->product }}</option>
                                </select>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control form-control-lg"
                                    value="{{ $invoices->discount }}" id="Discount" name="Discount" readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">نسبة ضريبة القيمة المضافة</label>
                                <select name="Rate_VAT" id="Rate_VAT" class="form-control" disabled readonly>
                                    <!--placeholder-->
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="Value_VAT"
                                    value="{{ $invoices->value_vat }}" name="Value_VAT" readonly>
                            </div>

                            <div class="col">
                                <label for="inputName" class="control-label">الاجمالي شامل الضريبة</label>
                                <input type="text" class="form-control" value="{{ $invoices->total }}"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <textarea class="form-control" value="{{ $invoices->note }}" id="exampleTextarea" name="note" rows="3"
                                    readonly></textarea>
                            </div>
                        </div><br>
                        <div class="row">
                            <div class="col">
                                <label for="exampleTextarea">تغيير حالة الدفع </label>
                            ...
                            <div class="col">
                                <label for="exampleTextarea"> تاريخ الدفع </label>
