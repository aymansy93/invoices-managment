...
<aside class="app-sidebar sidebar-scroll">
    ...
    <div class="main-sidemenu">
        ...
        <ul class="side-menu">
            <li class="side-item side-item-category">منصة الدفع الألكتروني</li>
            <li class="slide">
            ...
            @can('الفواتير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('paidding')
                            <li><a class="slide-item" href="{{ route('paidding', ['id' => 1]) }}">الفواتير المدفوعة</a></li>

                            <li><a class="slide-item" href="{{ route('paidding', ['id' => 2]) }}">الفواتير الغير مدفوعة</a>
                            </li>
                            <li><a class="slide-item" href="{{ route('paidding', ['id' => 3]) }}">الفواتير المدفوعة جزئيا</a>
                            </li>
                        @endcan
                        @can('ارشيف الفواتير')
            ...
            @can('التقارير')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        @can('تقرير الفواتير')
                            <li><a class="slide-item" href="{{ route('report') }}">تقارير الفواتير</a></li>
                        @endcan
                        @can('تقرير العملاء')
                            <li><a class="slide-item" href="{{ route('customer.report') }}">تقارير العملاء</a>
                            @endcan
                        </li>
                    </ul>
                </li>
            ...
            @can('الاعدادات')
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @endcan
                        @can('المنتجات')
                            <li><a class="slide-item" href="{{ route('products.index') }}">اضافة منتج </a></li>
                        @endcan
