...
@endsection
@section('title')
التقارير - منصة الدفع الالكتروني
@endsection
@section('page-header')
    ...
    <div class="col-xl-12">
        <div class="card mg-b-20">
            <div class="card-header pb-0">
                <form action="{{route('report.search')}}" method="post" autocomplete="off">
                    @csrf

                    <div class="col-lg-3">
                        <label class="rdiobox">
                            <input checked name="search" type="radio" value="1" id="type_div"> <span>بحث بنوع
                                الفاتورة</span></label>
                    </div>


                    <div class="col-lg-3 mg-t-20 mg-lg-t-0">
                        <label class="rdiobox"><input name="search" value="2" type="radio"><span>بحث برقم الفاتورة
                            </span></label>
                    </div><br><br>
